...
import {defaultData, spinnerDefaultPosition} from './spinner-const';
...
export function Spinner(props: PropsType): Node {
    ...
    const position = rawPosition || spinnerDefaultPosition;
    ...
    return (
        <div
            className={classNames(spinnerStyle.spinner_wrapper, className, {
                [spinnerStyle.spinner_wrapper__static]: position === spinnerDefaultPosition,
            })}
